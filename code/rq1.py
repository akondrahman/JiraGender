...
utility.dumpContent(issue_reports_for_females, 'F_ALL')
print "Female reports",sum(issue_reports_for_females)
# issue_reports_for_males = getIssueReportsList(allTheMales)
# utility.dumpContent(issue_reports_for_females, 'M_ALL')
# print "Male reports",sum(issue_reports_for_males)
